...
export const RELEASES_API_URL =
  'https://api.github.com/repos/jhonsstn/nx-library-manager/releases/latest';
export const RELEASES_PAGE_URL = 'https://github.com/jhonsstn/nx-library-manager/releases';
