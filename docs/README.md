...
The app owns its SQLite database, settings, and caches under Electron's user-data directory. It does not import, migrate, read, or share data with the earlier Python application.
