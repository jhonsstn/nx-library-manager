...
The current Python implementation caches token payloads in SQLite; migration may preserve this or move credentials/tokens to a dedicated settings/secure cache layer.
...
6. Auto-apply only if confidence satisfies current parity threshold.
